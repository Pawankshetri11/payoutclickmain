        ...
        <CardContent className="pt-6">
          <Tabs value={selectedPage} onValueChange={setSelectedPage}>
            ...
            <TabsContent value="support" className="space-y-6 mt-6">
              <div className="space-y-4">
                <h3 className="text-lg font-semibold">Support Page Contact Information</h3>
                <p className="text-sm text-muted-foreground">Configure contact methods displayed on the support page</p>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="support-email"
                    type="email"
                    value={pages.support.email}
                    onChange={(e) => setPages({
                      ...pages,
                      support: { ...pages.support, email: e.target.value }
                    })}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="support-phone"
                    value={pages.support.phone}
                    onChange={(e) => setPages({
                      ...pages,
                      support: { ...pages.support, phone: e.target.value }
                    })}
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="support-telegram">Telegram Username</Label>
                  <Input
                    id="support-telegram"
                    placeholder="@YourSupportBot"
                    value={pages.support.telegram}
                    onChange={(e) => setPages({
                      ...pages,
                      support: { ...pages.support, telegram: e.target.value }
                    })}
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="support-telegram-link">Telegram Link</Label>
                  <Input
                    id="support-telegram-link"
                    placeholder="https://t.me/YourSupportBot"
                    value={pages.support.telegram_link}
                    onChange={(e) => setPages({
                      ...pages,
                      support: { ...pages.support, telegram_link: e.target.value }
                    })}
                  />
                  <p className="text-xs text-muted-foreground">
                    Full URL to your Telegram bot or group
                  </p>
                </div>
              </div>
            </TabsContent>
