  ...
  const handleCreateJob = async () => {
    try {
      ...
      const jobData: any = {
        ...
        approval_required: newJobData.type !== 'code',
        submission_limit_per_user: parseInt(newJobData.submissionLimit) || 1
      };

      if (newJobData.type === 'review') {
        jobData.review_profiles = newJobData.reviewProfiles;
      }
  ...
  const handleUpdateJob = async () => {
    try {
      ...
      const updatedJobData: any = {
        ...
        approval_required: editJobData.type !== 'code',
              ...
              <div className="space-y-2">
                ...
                <Select value={newJobData.type} onValueChange={(val: "code" | "image" | "image_only" | "review") => setNewJobData({...newJobData, type: val})}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="review">Review Task (Manual approval)</SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-xs text-muted-foreground">
                  ...
                  {newJobData.type === 'review' && 'Review tasks show business profiles and require admin approval.'}
                </p>
              </div>
