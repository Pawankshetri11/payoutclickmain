    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          {/* Global lock setting moved here */}
          <GlobalLockSetting />
        ...
        <Dialog open={editProfileOpen} onOpenChange={setEditProfileOpen}>
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="edit-cooldown_hours">Cooldown Hours *</Label>
                <Input
                        ...
                        <Button 
                          ...
                          onClick={() => {
                            ...
                            setFormData({
                              ...
                              cooldown_hours: profile.cooldown_hours?.toString() || '24'
                            });
...
// Inline component to manage global lock setting
const GlobalLockSetting = () => {
  const { getSetting, updateSetting } = useSystemSettings();
  const [minutes, setMinutes] = useState<number>(getSetting('global_review_lock_minutes', 60));

  const handleSave = () => {
    updateSetting('global_review_lock_minutes', Number(minutes));
    toast.success('Global lock timer updated');
  };

  return (
    <div className="flex items-center gap-2">
      <Label className="text-sm">Global Lock (min)</Label>
      <Input
        type="number"
        min={0}
        value={minutes}
