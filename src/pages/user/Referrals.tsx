        ...
        <CardContent>
          <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4 p-3 md:p-4 bg-muted/30 rounded-lg border border-border/50">
            <div className="flex-1">
              <Label htmlFor="code" className="text-xs md:text-sm font-medium">Referral Code</Label>
              <div className="text-xl md:text-2xl font-bold text-primary mt-1">{referralCode || 'Loading...'}</div>
            </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-xs md:text-sm">Earnings</TableHead>
                ...
                <TableBody>
                  {referredUsers.map((user) => (
                    <TableRow key={user.id} className="hover:bg-accent/50">
                      ...
                      <TableCell className="text-xs md:text-sm font-medium text-primary">
                        ₹{user.totalEarnings}
                      </TableCell>
